...
//
// Hardware: XIAO W5500 Adapter
//
// Letzte Änderung: 01.08.2025
// Ethernet Adaptions: 2025-08-09 Claus Kühnel info@ckuehnel.ch
// =================================================================================================
#include <WebServer.h>
...
WiFiServer mqttServer(mqttPort);  // Bei ETH.h gibt es keine eigene Klasse wie ETHServer. 
                                  // Verwende einfach WiFiServer, genau wie bei WLAN, nur dass die Verbindung eben über das ETH-Interface läuft.
WebServer web(80);
...
void setup() {
  ...
  Serial.println("Setup XIAO W5500 LAN MQTT Broker...");
  delay(2000);
