...
// Adaption: 4.08.2025 Claus Kühnel info@ckuehnel.ch
// =================================================================================================
#include <WiFi.h>
#include <WebServer.h>
...
#include <M5StickCPlus2.h> // V.1.0.1
...
void setup() {
    ...
    M5.Lcd.printf("ESP32 MQTT Broker");
...
void handlePublish(MQTTClientState& clientState, byte header, int remainingLength) {
    ...
    M5.Lcd.printf("Received:\n");
    M5.Lcd.fillRect(0, 80, 240, 135, DARKGREY);
    M5.Lcd.printf("T: %s\n", topic.c_str());
    M5.Lcd.printf("C: %s\n", payload.c_str());
